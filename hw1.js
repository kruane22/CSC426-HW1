...
const Product = class Product {
    ...
    static halfOff = (products) => {
        return products.map(element=>{return {...element, price:element.price*.5}} );
    }
    ...
    static printProducts = (products) => {
        products.map(element => {
            let printStatement = `Product: ${element.name}, Cost: $${element.price.toFixed(2)}, Availability: ${element.availability==="In Stock" ? "Yes" : "No"}`
